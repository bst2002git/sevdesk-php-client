...
```php
contactCustomerNumberAvailabilityCheck($customer_number): \OpenAPI\Client\Model\GetIsInvoicePartiallyPaid200Response
```
...
```php
createContact($model_contact): \OpenAPI\Client\Model\CreateContact201Response
```
...
[**\OpenAPI\Client\Model\CreateContact201Response**](../Model/CreateContact201Response.md)
...
```php
deleteContact($contact_id): \OpenAPI\Client\Model\DeleteAccountingContact200Response
```
...
```php
findContactsByCustomFieldValue($value, $custom_field_setting_id, $custom_field_setting_object_name, $custom_field_name): \OpenAPI\Client\Model\CreateContact201Response
```
...
```php
getContactById($contact_id): \OpenAPI\Client\Model\CreateContact201Response
```
...
```php
getContactTabsItemCountById($contact_id): \OpenAPI\Client\Model\GetContactTabsItemCountById200Response
```
...
[**\OpenAPI\Client\Model\GetContactTabsItemCountById200Response**](../Model/GetContactTabsItemCountById200Response.md)
...
```php
getContacts($count_all, $limit, $offset, $depth, $customer_number): \OpenAPI\Client\Model\GetContacts200Response
```
...
```php
getNextCustomerNumber(): \OpenAPI\Client\Model\GetNextCustomerNumber200Response
```
...
[**\OpenAPI\Client\Model\GetNextCustomerNumber200Response**](../Model/GetNextCustomerNumber200Response.md)
...
```php
updateContact($contact_id, $model_contact_update): \OpenAPI\Client\Model\CreateContact201Response
```
