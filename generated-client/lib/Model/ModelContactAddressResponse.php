...
/**
 * ModelContactAddressResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelContactAddressResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactAddressResponse';
    ...
    protected static $openAPITypes = [
        ...
        'create' => '\DateTime',
        'update' => '\DateTime',
        'contact' => '\OpenAPI\Client\Model\ModelContactAddressContact',
        'street' => 'string',
        'zip' => 'string',
        'city' => 'string',
        'country' => '\OpenAPI\Client\Model\ModelContactAddressCountry',
        'category' => '\OpenAPI\Client\Model\ModelContactAddressCategory',
        'name' => 'string',
        'sev_client' => '\OpenAPI\Client\Model\ModelContactAddressSevClient',
        'name2' => 'string',
        'name3' => 'string',
        'name4' => 'string'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The contact address id
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string|null $object_name The contact address object name
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param \DateTime|null $create Date of contact address creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \DateTime|null $update Date of last contact address update
     *
     * @return self
     */
     ...
     * Gets contact
     *
     * @return \OpenAPI\Client\Model\ModelContactAddressContact
     */
     ...
     * Sets contact
     *
     * @param \OpenAPI\Client\Model\ModelContactAddressContact $contact contact
     *
     * @return self
     */
     ...
     * Sets zip
     *
     * @param string|null $zip Zib code
     *
     * @return self
     */
     ...
     * Gets country
     *
     * @return \OpenAPI\Client\Model\ModelContactAddressCountry
     */
     ...
     * Sets country
     *
     * @param \OpenAPI\Client\Model\ModelContactAddressCountry $country country
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name in address
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \OpenAPI\Client\Model\ModelContactAddressSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \OpenAPI\Client\Model\ModelContactAddressSevClient|null $sev_client sev_client
     *
     * @return self
     */
     ...
     * Sets name2
     *
     * @param string|null $name2 Second name in address
     *
     * @return self
     */
     ...
     * Sets name3
     *
     * @param string|null $name3 Third name in address
     *
     * @return self
     */
    ...
    {
        if (is_null($name3)) {
            array_push($this->openAPINullablesSetToNull, 'name3');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('name3', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets name4
     *
     * @param string|null $name4 Fourth name in address
     *
     * @return self
     */
    ...
    {
        if (is_null($name4)) {
            array_push($this->openAPINullablesSetToNull, 'name4');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('name4', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
