 ...
 */
class ModelCreditNotePosResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_creditNotePosResponse';
    ...
    protected static $openAPITypes = [
        ...
        'create' => 'string',
        'update' => 'string',
        'credit_note' => '\OpenAPI\Client\Model\ModelCreditNotePosResponseCreditNote',
        'part' => '\OpenAPI\Client\Model\ModelCreditNotePosResponsePart',
        'quantity' => 'string',
        'price' => 'string',
        'price_net' => 'string',
        'price_tax' => 'string',
        'price_gross' => 'string',
        'name' => 'string',
        'unity' => '\OpenAPI\Client\Model\ModelCreditNotePosResponseUnity',
        'sev_client' => '\OpenAPI\Client\Model\ModelCreditNotePosResponseSevClient',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('credit_note', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['credit_note'] === null) {
            $invalidProperties[] = "'credit_note' can't be null";
        }
     ...
     * Sets id
     *
     * @param string|null $id The creditNote position id
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string|null $object_name The creditNote position object name
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param string|null $create Date of creditNote position creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param string|null $update Date of last creditNote position update
     *
     * @return self
     */
     ...
     * Gets credit_note
     *
     * @return \OpenAPI\Client\Model\ModelCreditNotePosResponseCreditNote
     */
     ...
     * Sets credit_note
     *
     * @param \OpenAPI\Client\Model\ModelCreditNotePosResponseCreditNote $credit_note credit_note
     *
     * @return self
     */
    public function setCreditNote($credit_note)
    {
        if (is_null($credit_note)) {
            throw new \InvalidArgumentException('non-nullable credit_note cannot be null');
        }
     ...
     * Gets part
     *
     * @return \OpenAPI\Client\Model\ModelCreditNotePosResponsePart|null
     */
     ...
     * Sets part
     *
     * @param \OpenAPI\Client\Model\ModelCreditNotePosResponsePart|null $part part
     *
     * @return self
     */
     ...
     * Gets unity
     *
     * @return \OpenAPI\Client\Model\ModelCreditNotePosResponseUnity
     */
     ...
     * Sets unity
     *
     * @param \OpenAPI\Client\Model\ModelCreditNotePosResponseUnity $unity unity
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \OpenAPI\Client\Model\ModelCreditNotePosResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \OpenAPI\Client\Model\ModelCreditNotePosResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
     ...
     *
     * @param string|null $position_number Position number of your position. Can be used to creditNote multiple positions.
     *
     * @return self
     */
     ...
     * Sets optional
     *
     * @param bool|null $optional Defines if the position is optional.
     *
     * @return self
     */
