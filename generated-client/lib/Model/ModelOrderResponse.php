 ...
 */
class ModelOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_OrderResponse';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Please have a look in       <a href='https://api.sevdesk.de/#section/Types-and-status-of-orders'>status of orders</a>      to see what the different status codes mean
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string|null $version Version of the order.<br>      Can be used if you have multiple drafts for the same order.<br>      Should start with 0
     *
     * @return self
     */
     ...
     * Sets sum_net
     *
     * @param string|null $sum_net Net sum of the order
     *
     * @return self
     */
     ...
     * Sets sum_tax
     *
     * @param string|null $sum_tax Tax sum of the order
     *
     * @return self
     */
     ...
     * Sets sum_gross
     *
     * @param string|null $sum_gross Gross sum of the order
     *
     * @return self
     */
     ...
     * Sets sum_discounts
     *
     * @param string|null $sum_discounts Sum of all discounts in the order
     *
     * @return self
     */
     ...
     *
     * @param string|null $sum_net_foreign_currency Net sum of the order in the foreign currency
     *
     * @return self
     */
     ...
     *
     * @param string|null $sum_tax_foreign_currency Tax sum of the order in the foreign currency
     *
     * @return self
     */
     ...
     *
     * @param string|null $sum_gross_foreign_currency Gross sum of the order in the foreign currency
     *
     * @return self
     */
     ...
     *
     * @param string|null $sum_discounts_foreign_currency Discounts sum of the order in the foreign currency
     *
     * @return self
     */
