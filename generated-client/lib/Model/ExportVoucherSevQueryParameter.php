 ...
 */
class ExportVoucherSevQueryParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'exportVoucher_sevQuery_parameter';
    ...
    */
     ...
     * Sets model_name
     *
     * @param mixed $model_name Model name, which is 'Voucher'
     *
     * @return self
     */
