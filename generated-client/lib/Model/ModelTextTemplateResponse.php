...
/**
 * ModelTextTemplateResponse Class Doc Comment
 *
 * @category Class
 * @description text template model
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ModelTextTemplateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_TextTemplateResponse';
    ...
    public const OBJECT_TYPE_AN = 'AN';
    public const OBJECT_TYPE_AB = 'AB';
    public const OBJECT_TYPE_CN = 'CN';
    public const OBJECT_TYPE_LI = 'LI';
    public const OBJECT_TYPE_MA = 'MA';
    public const OBJECT_TYPE_RE = 'RE';
    public const OBJECT_TYPE_PAYMENT_CONFIRMATION = 'PAYMENT_CONFIRMATION';
    public const TEXT_TYPE_HEAD = 'HEAD';
    public const TEXT_TYPE_FOOT = 'FOOT';
    public const TEXT_TYPE_SUBJECT = 'SUBJECT';
    public const TEXT_TYPE_TEXT = 'TEXT';
    public const TEXT_TYPE_SIGNATURE = 'SIGNATURE';
    ...
    public function getObjectTypeAllowableValues()
    {
        return [
            ...
            self::OBJECT_TYPE_MA,
            self::OBJECT_TYPE_RE,
            self::OBJECT_TYPE_PAYMENT_CONFIRMATION,
        ];
    }
    ...
    public function getTextTypeAllowableValues()
    {
        return [
            self::TEXT_TYPE_HEAD,
            self::TEXT_TYPE_FOOT,
            self::TEXT_TYPE_SUBJECT,
            self::TEXT_TYPE_TEXT,
            self::TEXT_TYPE_SIGNATURE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sev_user', $data ?? [], null);
    ...
    */
     ...
     * Sets create
     *
     * @param \DateTime|null $create date the text template was created
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \DateTime|null $update date the text template was last updated
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param float|null $id id of the text template
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name name of the text template
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text text of your text template
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param string|null $category The category of the new Text Template.
     *
     * @return self
     */
     ...
     * Sets object_type
     *
     * @param string|null $object_type object type for which you want to use the text template
     *
     * @return self
     */
     ...
     * Sets text_type
     *
     * @param string|null $text_type type of your text
     *
     * @return self
     */
     ...
     * Sets sev_user
     *
     * @param object|null $sev_user sevUser who created the text template
     *
     * @return self
     */
    ...
    {
        if (is_null($sev_user)) {
            throw new \InvalidArgumentException('non-nullable sev_user cannot be null');
        }
     ...
     * Sets main
     *
     * @param bool|null $main defines if the text template is used as the main template
     *
     * @return self
     */
