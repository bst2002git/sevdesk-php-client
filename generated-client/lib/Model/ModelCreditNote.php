 ...
 */
class ModelCreditNote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_creditNote';
    ...
    protected static $openAPITypes = [
        ...
        'contact' => '\OpenAPI\Client\Model\ModelCreditNoteContact',
        ...
        'contact_person' => '\OpenAPI\Client\Model\ModelCreditNoteContactPerson',
        'tax_rate' => 'float',
    ...
    public const BOOKING_CATEGORY_PROVISION = 'PROVISION';
    public const BOOKING_CATEGORY_ROYALTY_ASSIGNED = 'ROYALTY_ASSIGNED';
    public const BOOKING_CATEGORY_ROYALTY_UNASSIGNED = 'ROYALTY_UNASSIGNED';
    public const BOOKING_CATEGORY_UNDERACHIEVEMENT = 'UNDERACHIEVEMENT';
    public const BOOKING_CATEGORY_ACCOUNTING_TYPE = 'ACCOUNTING_TYPE';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('booking_category', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['booking_category']) && !in_array($this->container['booking_category'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'booking_category', must be one of '%s'",
                $this->container['booking_category'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets id
     *
     * @param int|null $id The creditNote id. <span style='color:red'>Required</span> if you want to create/update an credit note position for an existing credit note\"
     *
     * @return self
     */
     ...
     * Gets contact
     *
     * @return \OpenAPI\Client\Model\ModelCreditNoteContact
     */
     ...
     * Sets contact
     *
     * @param \OpenAPI\Client\Model\ModelCreditNoteContact $contact contact
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ModelCreditNoteAddressCountry
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ModelCreditNoteAddressCountry $address_country address_country
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version Version of the creditNote.<br>      Can be used if you have multiple drafts for the same creditNote.<br>      Should start with 0
     *
     * @return self
     */
     ...
     * Gets contact_person
     *
     * @return \OpenAPI\Client\Model\ModelCreditNoteContactPerson
     */
     ...
     * Sets contact_person
     *
     * @param \OpenAPI\Client\Model\ModelCreditNoteContactPerson $contact_person contact_person
     *
     * @return self
     */
     ...
     *
     * @param string|null $credit_note_type Type of the creditNote.
     *
     * @return self
     */
    public function setCreditNoteType($credit_note_type)
    {
        if (is_null($credit_note_type)) {
            throw new \InvalidArgumentException('non-nullable credit_note_type cannot be null');
        }
     ...
     *
     * @param string|null $booking_category defines the booking category, for more information see the section \"<a href='https://api.sevdesk.de/#section/Credit-note-booking-categories'>Credit note booking categories</a>\"
     *
     * @return self
     */
    public function setBookingCategory($booking_category)
    {
        if (is_null($booking_category)) {
            array_push($this->openAPINullablesSetToNull, 'booking_category');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('booking_category', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getBookingCategoryAllowableValues();
        if (!is_null($booking_category) && !in_array($booking_category, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'booking_category', must be one of '%s'",
                    $booking_category,
     ...
     * Sets sum_net
     *
     * @param float|null $sum_net Net sum of the creditNote
     *
     * @return self
     */
     ...
     * Sets sum_tax
     *
     * @param float|null $sum_tax Tax sum of the creditNote
     *
     * @return self
     */
     ...
     * Sets sum_gross
     *
     * @param float|null $sum_gross Gross sum of the creditNote
     *
     * @return self
     */
     ...
     * Sets sum_discounts
     *
     * @param float|null $sum_discounts Sum of all discounts in the creditNote
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_net_foreign_currency Net sum of the creditNote in the foreign currency
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_tax_foreign_currency Tax sum of the creditNote in the foreign currency
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_gross_foreign_currency Gross sum of the creditNote in the foreign currency
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_discounts_foreign_currency Discounts sum of the creditNote in the foreign currency
     *
     * @return self
     */
