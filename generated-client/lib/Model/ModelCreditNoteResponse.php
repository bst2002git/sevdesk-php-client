...
class ModelCreditNoteResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'contact' => '\OpenAPI\Client\Model\ModelCreditNoteResponseContact',
        'credit_note_date' => '\DateTime',
        'status' => 'string',
        'header' => 'string',
        'head_text' => 'string',
        'foot_text' => 'string',
        'address_country' => '\OpenAPI\Client\Model\ModelCreditNoteResponseAddressCountry',
        'create_user' => '\OpenAPI\Client\Model\ModelInvoiceResponseCreateUser',
        'sev_client' => '\OpenAPI\Client\Model\ModelCreditNoteResponseSevClient',
        'delivery_terms' => 'string',
        'delivery_date' => '\DateTime',
        'payment_terms' => 'string',
        'version' => 'string',
        'small_settlement' => 'bool',
        'contact_person' => '\OpenAPI\Client\Model\ModelCreditNoteResponseContactPerson',
        'tax_rate' => 'string',
        'tax_set' => '\OpenAPI\Client\Model\ModelCreditNoteResponseTaxSet',
        'tax_text' => 'string',
        'tax_type' => 'string',
    ...
    */
     ...
     * Gets contact
     *
     * @return \OpenAPI\Client\Model\ModelCreditNoteResponseContact|null
     */
     ...
     * Sets contact
     *
     * @param \OpenAPI\Client\Model\ModelCreditNoteResponseContact|null $contact contact
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ModelCreditNoteResponseAddressCountry|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ModelCreditNoteResponseAddressCountry|null $address_country address_country
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \OpenAPI\Client\Model\ModelCreditNoteResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \OpenAPI\Client\Model\ModelCreditNoteResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
     ...
     * Gets contact_person
     *
     * @return \OpenAPI\Client\Model\ModelCreditNoteResponseContactPerson|null
     */
     ...
     * Sets contact_person
     *
     * @param \OpenAPI\Client\Model\ModelCreditNoteResponseContactPerson|null $contact_person contact_person
     *
     * @return self
     */
     ...
     * Gets tax_set
     *
     * @return \OpenAPI\Client\Model\ModelCreditNoteResponseTaxSet|null
     */
     ...
     * Sets tax_set
     *
     * @param \OpenAPI\Client\Model\ModelCreditNoteResponseTaxSet|null $tax_set tax_set
     *
     * @return self
     */
     ...
     * Sets tax_type
     *
     * @param string|null $tax_type Tax type of the creditNote. There are four tax types: 1. default - Umsatzsteuer ausweisen 2. eu - Steuerfreie innergemeinschaftliche Lieferung (Europäische Union) 3. noteu - Steuerschuldnerschaft des Leistungsempfängers (außerhalb EU, z. B. Schweiz) 4. custom - Using custom tax set 5. ss - Not subject to VAT according to §19 1 UStG Tax rates are heavily connected to the tax type used.
     *
     * @return self
     */
