...
/**
 * ModelCheckAccountTransactionResponseSourceTransaction Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCheckAccountTransactionResponseSourceTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_CheckAccountTransactionResponse_sourceTransaction';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the check account transaction
     *
     * @return self
     */
