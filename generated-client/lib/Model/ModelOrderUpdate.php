 ...
 */
class ModelOrderUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_OrderUpdate';
    ...
    protected static $openAPITypes = [
        ...
        'update' => '\DateTime',
        'order_number' => 'string',
        'contact' => '\OpenAPI\Client\Model\ModelOrderUpdateContact',
        'order_date' => '\DateTime',
        'status' => 'int',
        'header' => 'string',
        'head_text' => 'string',
        'foot_text' => 'string',
        'address_country' => '\OpenAPI\Client\Model\ModelOrderUpdateAddressCountry',
        'create_user' => '\OpenAPI\Client\Model\ModelOrderUpdateCreateUser',
        'sev_client' => '\OpenAPI\Client\Model\ModelOrderUpdateSevClient',
        'delivery_terms' => 'string',
        'payment_terms' => 'string',
        'origin' => '\OpenAPI\Client\Model\ModelOrderOrigin',
        'version' => 'int',
        'small_settlement' => 'bool',
        'contact_person' => '\OpenAPI\Client\Model\ModelOrderUpdateContactPerson',
        'tax_rate' => 'float',
        'tax_set' => '\OpenAPI\Client\Model\ModelOrderUpdateTaxSet',
        'tax_text' => 'string',
        'tax_type' => 'string',
        'order_type' => 'string',
        'send_date' => '\DateTime',
    ...
    public const STATUS_750 = 750;
    public const STATUS_1000 = 1000;
    public const ORDER_TYPE_AN = 'AN';
    public const ORDER_TYPE_AB = 'AB';
    public const ORDER_TYPE_LI = 'LI';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string|null $object_name The order object name
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param \DateTime|null $create Date of order creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \DateTime|null $update Date of last order update
     *
     * @return self
     */
     ...
     * Gets contact
     *
     * @return \OpenAPI\Client\Model\ModelOrderUpdateContact|null
     */
     ...
     * Sets contact
     *
     * @param \OpenAPI\Client\Model\ModelOrderUpdateContact|null $contact contact
     *
     * @return self
     */
     ...
     * Sets order_date
     *
     * @param \DateTime|null $order_date Needs to be provided as timestamp or dd.mm.yyyy
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param int|null $status Please have a look in       <a href='https://api.sevdesk.de/#section/Types-and-status-of-orders'>status of orders</a>      to see what the different status codes mean
     *
     * @return self
     */
     ...
     * Sets header
     *
     * @param string|null $header Normally consist of prefix plus the order number
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ModelOrderUpdateAddressCountry|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ModelOrderUpdateAddressCountry|null $address_country address_country
     *
     * @return self
     */
     ...
     * Gets create_user
     *
     * @return \OpenAPI\Client\Model\ModelOrderUpdateCreateUser|null
     */
     ...
     * Sets create_user
     *
     * @param \OpenAPI\Client\Model\ModelOrderUpdateCreateUser|null $create_user create_user
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \OpenAPI\Client\Model\ModelOrderUpdateSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \OpenAPI\Client\Model\ModelOrderUpdateSevClient|null $sev_client sev_client
     *
     * @return self
     */
     ...
     * Sets delivery_terms
     *
     * @param string|null $delivery_terms Delivery terms of the order
     *
     * @return self
     */
     ...
     * Sets payment_terms
     *
     * @param string|null $payment_terms Payment terms of the order
     *
     * @return self
     */
     ...
     * Gets origin
     *
     * @return \OpenAPI\Client\Model\ModelOrderOrigin|null
     */
     ...
     * Sets origin
     *
     * @param \OpenAPI\Client\Model\ModelOrderOrigin|null $origin origin
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param int|null $version Version of the order.<br>      Can be used if you have multiple drafts for the same order.<br>      Should start with 0
     *
     * @return self
     */
     ...
     *
     * @param bool|null $small_settlement Defines if the client uses the small settlement scheme.      If yes, the order must not contain any vat
     *
     * @return self
     */
     ...
     * Gets contact_person
     *
     * @return \OpenAPI\Client\Model\ModelOrderUpdateContactPerson|null
     */
     ...
     * Sets contact_person
     *
     * @param \OpenAPI\Client\Model\ModelOrderUpdateContactPerson|null $contact_person contact_person
     *
     * @return self
     */
     ...
     * Gets tax_set
     *
     * @return \OpenAPI\Client\Model\ModelOrderUpdateTaxSet|null
     */
     ...
     * Sets tax_set
     *
     * @param \OpenAPI\Client\Model\ModelOrderUpdateTaxSet|null $tax_set tax_set
     *
     * @return self
     */
     ...
     * Sets tax_type
     *
     * @param string|null $tax_type Tax type of the order. There are four tax types: 1. default - Umsatzsteuer ausweisen 2. eu - Steuerfreie innergemeinschaftliche Lieferung (Europäische Union) 3. noteu - Steuerschuldnerschaft des Leistungsempfängers (außerhalb EU, z. B. Schweiz) 4. custom - Using custom tax set 5. ss - Not subject to VAT according to §19 1 UStG Tax rates are heavily connected to the tax type used.
     *
     * @return self
     */
     ...
     * Sets order_type
     *
     * @param string|null $order_type Type of the order. For more information on the different types, check      <a href='https://api.sevdesk.de/#section/Types-and-status-of-orders'>this</a>
     *
     * @return self
     */
     ...
     * Sets send_date
     *
     * @param \DateTime|null $send_date The date the order was sent to the customer
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Currency used in the order. Needs to be currency code according to ISO-4217
     *
     * @return self
     */
     ...
     * Sets sum_net
     *
     * @param float|null $sum_net Net sum of the order
     *
     * @return self
     */
     ...
     * Sets sum_tax
     *
     * @param float|null $sum_tax Tax sum of the order
     *
     * @return self
     */
     ...
     * Sets sum_gross
     *
     * @param float|null $sum_gross Gross sum of the order
     *
     * @return self
     */
     ...
     * Sets sum_discounts
     *
     * @param float|null $sum_discounts Sum of all discounts in the order
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_net_foreign_currency Net sum of the order in the foreign currency
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_tax_foreign_currency Tax sum of the order in the foreign currency
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_gross_foreign_currency Gross sum of the order in the foreign currency
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_discounts_foreign_currency Discounts sum of the order in the foreign currency
     *
     * @return self
     */
     ...
     * Sets show_net
     *
     * @param bool|null $show_net If true, the net amount of each position will be shown on the order. Otherwise gross amount
     *
     * @return self
     */
     ...
     * Sets send_type
     *
     * @param string|null $send_type Type which was used to send the order. IMPORTANT: Please refer to the order section of the       *     API-Overview to understand how this attribute can be used before using it!
     *
     * @return self
     */
