 ...
 */
class ModelVoucherPos implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_VoucherPos';
    ...
    protected static $openAPITypes = [
        ...
        'create' => 'string',
        'update' => 'string',
        'sev_client' => '\OpenAPI\Client\Model\ModelVoucherPosSevClient',
        'voucher' => '\OpenAPI\Client\Model\ModelVoucherPosVoucher',
        'accounting_type' => '\OpenAPI\Client\Model\ModelVoucherPosAccountingType',
        'estimated_accounting_type' => '\OpenAPI\Client\Model\ModelVoucherPosEstimatedAccountingType',
        'tax_rate' => 'float',
        'net' => 'bool',
        'is_asset' => 'bool',
        'sum_net' => 'float',
    ...
    protected static array $openAPINullables = [
		...
		'estimated_accounting_type' => false,
		'tax_rate' => false,
		'net' => false,
		'is_asset' => false,
		'sum_net' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('estimated_accounting_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accounting_type'] === null) {
            $invalidProperties[] = "'accounting_type' can't be null";
        }
        ...
        if ($this->container['sum_net'] === null) {
            $invalidProperties[] = "'sum_net' can't be null";
        }
        if ($this->container['sum_gross'] === null) {
            $invalidProperties[] = "'sum_gross' can't be null";
        }
     ...
     * Sets id
     *
     * @param int|null $id The voucher position id
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name The voucher position object name
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param string|null $create Date of voucher position creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param string|null $update Date of last voucher position update
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \OpenAPI\Client\Model\ModelVoucherPosSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \OpenAPI\Client\Model\ModelVoucherPosSevClient|null $sev_client sev_client
     *
     * @return self
     */
     ...
     * Gets voucher
     *
     * @return \OpenAPI\Client\Model\ModelVoucherPosVoucher
     */
     ...
     * Sets voucher
     *
     * @param \OpenAPI\Client\Model\ModelVoucherPosVoucher $voucher voucher
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ModelVoucherPosAccountingType
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ModelVoucherPosAccountingType $accounting_type accounting_type
     *
     * @return self
     */
    public function setAccountingType($accounting_type)
    {
        if (is_null($accounting_type)) {
            throw new \InvalidArgumentException('non-nullable accounting_type cannot be null');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\ModelVoucherPosEstimatedAccountingType|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ModelVoucherPosEstimatedAccountingType|null $estimated_accounting_type estimated_accounting_type
     *
     * @return self
     */
    public function setEstimatedAccountingType($estimated_accounting_type)
    {
        if (is_null($estimated_accounting_type)) {
            throw new \InvalidArgumentException('non-nullable estimated_accounting_type cannot be null');
        }
     ...
     * Sets tax_rate
     *
     * @param float $tax_rate Tax rate of the voucher position.
     *
     * @return self
     */
     ...
     * Sets net
     *
     * @param bool $net Determines whether 'sumNet' or 'sumGross' is regarded.<br>       If both are not given, 'sum' is regarded and treated as net or gross depending on 'net'.   All positions must be either net or gross, a mixture of the two is not possible.
     *
     * @return self
     */
     ...
     * Sets is_asset
     *
     * @param bool|null $is_asset Determines whether position is regarded as an asset which can be depreciated.
     *
     * @return self
     */
     ...
     * Sets sum_net
     *
     * @param float $sum_net Net sum of the voucher position.<br>      Only regarded if 'net' is 'true', otherwise its readOnly.
     *
     * @return self
     */
     ...
     * Sets sum_tax
     *
     * @param float|null $sum_tax Tax sum of the voucher position.
     *
     * @return self
     */
     ...
     * Sets sum_gross
     *
     * @param float $sum_gross Gross sum of the voucher position.<br>      Only regarded if 'net' is 'false', otherwise its readOnly.
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_net_accounting Net accounting sum. Is equal to sumNet.
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_tax_accounting Tax accounting sum. Is equal to sumTax.
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_gross_accounting Gross accounting sum. Is equal to sumGross.
     *
     * @return self
     */
     ...
     * Sets comment
     *
     * @param string|null $comment Comment for the voucher position.
     *
     * @return self
     */
