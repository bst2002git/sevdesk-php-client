...
/**
    ...
    /**
     * Operation createVoucherByFactory
     *
    ...
    {
        list($response) = $this->createVoucherByFactoryWithHttpInfo($save_voucher, $contentType);
        return $response;
    }

    /**
     * Operation createVoucherByFactoryWithHttpInfo
     *
     * Create a new voucher
     *
     * @param  \OpenAPI\Client\Model\SaveVoucher $save_voucher Creation data. Please be aware, that you need to provide at least all required parameter      of the voucher and voucher position model! (optional)
    ...
    /**
     * Operation createVoucherByFactoryAsync
     *
     * Create a new voucher
     *
     * @param  \OpenAPI\Client\Model\SaveVoucher $save_voucher Creation data. Please be aware, that you need to provide at least all required parameter      of the voucher and voucher position model! (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createVoucherByFactoryAsync($save_voucher = null, string $contentType = self::contentTypes['createVoucherByFactory'][0])
    {
        return $this->createVoucherByFactoryAsyncWithHttpInfo($save_voucher, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createVoucherByFactoryAsyncWithHttpInfo
     *
     * Create a new voucher
     *
     * @param  \OpenAPI\Client\Model\SaveVoucher $save_voucher Creation data. Please be aware, that you need to provide at least all required parameter      of the voucher and voucher position model! (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createVoucherByFactoryRequest($save_voucher = null, string $contentType = self::contentTypes['createVoucherByFactory'][0])
    {
     ...
     * Retrieve vouchers
     *
     * @param  float $status Status of the vouchers to retrieve. (optional)
     * @param  string $credit_debit Define if you only want credit or debit vouchers. (optional)
     * @param  string $description_like Retrieve all vouchers with a description like this. (optional)
     * @param  int $start_date Retrieve all vouchers with a date equal or higher (optional)
     * @param  int $end_date Retrieve all vouchers with a date equal or lower (optional)
     * @param  int $contact_id Retrieve all vouchers with this contact. Must be provided with contact[objectName] (optional)
    ...
    {
        list($response) = $this->getVouchersWithHttpInfo($status, $credit_debit, $description_like, $start_date, $end_date, $contact_id, $contact_object_name, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVouchersAsync($status = null, $credit_debit = null, $description_like = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getVouchers'][0])
    {
        return $this->getVouchersAsyncWithHttpInfo($status, $credit_debit, $description_like, $start_date, $end_date, $contact_id, $contact_object_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVouchersRequest($status = null, $credit_debit = null, $description_like = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getVouchers'][0])
    {
