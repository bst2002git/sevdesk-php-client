...
/**
     ...
     * @param  \OpenAPI\Client\Model\BookCreditNoteRequest $book_credit_note_request Booking data (optional)
     ...
     * @return \OpenAPI\Client\Model\BookCreditNote200Response
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\BookCreditNote200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function bookCreditNoteWithHttpInfo($credit_note_id, $book_credit_note_request = null, string $contentType = self::contentTypes['bookCreditNote'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\BookCreditNote200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\BookCreditNote200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\BookCreditNote200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\BookCreditNote200Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\BookCreditNote200Response',
     ...
     *
     * @param  \OpenAPI\Client\Model\SaveCreditNote $save_credit_note Creation data. Please be aware, that you need to provide at least all required parameter      of the credit note model! (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SaveCreditNoteResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SaveCreditNoteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createcreditNoteWithHttpInfo($save_credit_note = null, string $contentType = self::contentTypes['createcreditNote'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\SaveCreditNoteResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\SaveCreditNoteResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SaveCreditNoteResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\SaveCreditNoteResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\SaveCreditNoteResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \OpenAPI\Client\Model\CreditNoteSendByRequest $credit_note_send_by_request Specify the send type (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CreditNoteSendBy200Response
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CreditNoteSendBy200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function creditNoteSendByWithHttpInfo($credit_note_id, $credit_note_send_by_request = null, string $contentType = self::contentTypes['creditNoteSendBy'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CreditNoteSendBy200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CreditNoteSendBy200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CreditNoteSendBy200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\CreditNoteSendBy200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CreditNoteSendBy200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SendCreditNoteByPrinting200Response
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SendCreditNoteByPrinting200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function deletecreditNoteWithHttpInfo($credit_note_id, string $contentType = self::contentTypes['deletecreditNote'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\SendCreditNoteByPrinting200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\SendCreditNoteByPrinting200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SendCreditNoteByPrinting200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\SendCreditNoteByPrinting200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\SendCreditNoteByPrinting200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \OpenAPI\Client\Model\SendCreditNoteByPrinting200Response
     */
    public function getCreditNotes($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getCreditNotes'][0])
    {
        list($response) = $this->getCreditNotesWithHttpInfo($status, $credit_note_number, $start_date, $end_date, $contact_id, $contact_object_name, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\SendCreditNoteByPrinting200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCreditNotesWithHttpInfo($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getCreditNotes'][0])
    {
        $request = $this->getCreditNotesRequest($status, $credit_note_number, $start_date, $end_date, $contact_id, $contact_object_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCreditNotesAsync($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getCreditNotes'][0])
    {
        return $this->getCreditNotesAsyncWithHttpInfo($status, $credit_note_number, $start_date, $end_date, $contact_id, $contact_object_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCreditNotesAsyncWithHttpInfo($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getCreditNotes'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SendCreditNoteByPrinting200Response';
        $request = $this->getCreditNotesRequest($status, $credit_note_number, $start_date, $end_date, $contact_id, $contact_object_name, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCreditNotesRequest($status = null, $credit_note_number = null, $start_date = null, $end_date = null, $contact_id = null, $contact_object_name = null, string $contentType = self::contentTypes['getCreditNotes'][0])
    {
     ...
     * @return \OpenAPI\Client\Model\SendCreditNoteByPrinting200Response
     */
    public function sendCreditNoteViaEMail($credit_note_id, $send_invoice_via_e_mail_request = null, string $contentType = self::contentTypes['sendCreditNoteViaEMail'][0])
    {
        list($response) = $this->sendCreditNoteViaEMailWithHttpInfo($credit_note_id, $send_invoice_via_e_mail_request, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\SendCreditNoteByPrinting200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendCreditNoteViaEMailWithHttpInfo($credit_note_id, $send_invoice_via_e_mail_request = null, string $contentType = self::contentTypes['sendCreditNoteViaEMail'][0])
    {
        $request = $this->sendCreditNoteViaEMailRequest($credit_note_id, $send_invoice_via_e_mail_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendCreditNoteViaEMailAsync($credit_note_id, $send_invoice_via_e_mail_request = null, string $contentType = self::contentTypes['sendCreditNoteViaEMail'][0])
    {
        return $this->sendCreditNoteViaEMailAsyncWithHttpInfo($credit_note_id, $send_invoice_via_e_mail_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendCreditNoteViaEMailAsyncWithHttpInfo($credit_note_id, $send_invoice_via_e_mail_request = null, string $contentType = self::contentTypes['sendCreditNoteViaEMail'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SendCreditNoteByPrinting200Response';
        $request = $this->sendCreditNoteViaEMailRequest($credit_note_id, $send_invoice_via_e_mail_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendCreditNoteViaEMailRequest($credit_note_id, $send_invoice_via_e_mail_request = null, string $contentType = self::contentTypes['sendCreditNoteViaEMail'][0])
    {
     ...
     * @param  \OpenAPI\Client\Model\ModelCreditNoteUpdate $model_credit_note_update Update data (optional)
