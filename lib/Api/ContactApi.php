...
/**
     ...
     * @param  string $custom_field_setting_id ID of ContactCustomFieldSetting for which the value has to be checked. (optional)
     * @param  string $custom_field_setting_object_name Object name. Only needed if you also defined the ID of a ContactCustomFieldSetting. (optional)
    ...
    {
        list($response) = $this->findContactsByCustomFieldValueWithHttpInfo($value, $custom_field_setting_id, $custom_field_setting_object_name, $custom_field_name, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findContactsByCustomFieldValueAsync($value, $custom_field_setting_id = null, $custom_field_setting_object_name = null, $custom_field_name = null, string $contentType = self::contentTypes['findContactsByCustomFieldValue'][0])
    {
        return $this->findContactsByCustomFieldValueAsyncWithHttpInfo($value, $custom_field_setting_id, $custom_field_setting_object_name, $custom_field_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function findContactsByCustomFieldValueRequest($value, $custom_field_setting_id = null, $custom_field_setting_object_name = null, $custom_field_name = null, string $contentType = self::contentTypes['findContactsByCustomFieldValue'][0])
    {
     ...
     * @param  int $limit The max number of contacts (optional)
     * @param  int $offset Which offset to start with (optional)
     * @param  string $depth Defines if both organizations &lt;b&gt;and&lt;/b&gt; persons should be returned.&lt;br&gt;       &#39;0&#39; -&gt; only organizations, &#39;1&#39; -&gt; organizations and persons (optional)
    ...
    {
        list($response) = $this->getContactsWithHttpInfo($count_all, $limit, $offset, $depth, $customer_number, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactsAsync($count_all = null, $limit = null, $offset = null, $depth = null, $customer_number = null, string $contentType = self::contentTypes['getContacts'][0])
    {
        return $this->getContactsAsyncWithHttpInfo($count_all, $limit, $offset, $depth, $customer_number, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactsRequest($count_all = null, $limit = null, $offset = null, $depth = null, $customer_number = null, string $contentType = self::contentTypes['getContacts'][0])
    {
