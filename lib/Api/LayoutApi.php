...
/**
    ...
    /**
     * Operation getLetterpapersWithThumb
     *
    ...
    {
        list($response) = $this->getLetterpapersWithThumbWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getLetterpapersWithThumbWithHttpInfo
     *
     * Retrieve letterpapers
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getLetterpapersWithThumb'] to see the possible values for this operation
    ...
    /**
     * Operation getLetterpapersWithThumbAsync
     *
     * Retrieve letterpapers
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getLetterpapersWithThumb'] to see the possible values for this operation
     ...
     */
    public function getLetterpapersWithThumbAsync(string $contentType = self::contentTypes['getLetterpapersWithThumb'][0])
    {
        return $this->getLetterpapersWithThumbAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getLetterpapersWithThumbAsyncWithHttpInfo
     *
     * Retrieve letterpapers
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getLetterpapersWithThumb'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'getLetterpapersWithThumb'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getLetterpapersWithThumb'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getLetterpapersWithThumbRequest(string $contentType = self::contentTypes['getLetterpapersWithThumb'][0])
    {
    ...
    {
        list($response) = $this->getTemplatesWithHttpInfo($type, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTemplatesAsync($type = null, string $contentType = self::contentTypes['getTemplates'][0])
    {
        return $this->getTemplatesAsyncWithHttpInfo($type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTemplatesRequest($type = null, string $contentType = self::contentTypes['getTemplates'][0])
    {
    ...
    /**
     * Operation updateCreditNoteTemplate
     *
    ...
    /**
     * Operation updateCreditNoteTemplateWithHttpInfo
     *
     * Update an of credit note template
     *
     * @param  int $credit_note_id ID of credit note to update (required)
    ...
    /**
     * Operation updateCreditNoteTemplateAsync
     *
     * Update an of credit note template
     *
     * @param  int $credit_note_id ID of credit note to update (required)
    ...
    /**
     * Operation updateCreditNoteTemplateAsyncWithHttpInfo
     *
     * Update an of credit note template
     *
     * @param  int $credit_note_id ID of credit note to update (required)
    ...
    public function updateCreditNoteTemplateRequest($credit_note_id, $model_change_layout = null, string $contentType = self::contentTypes['updateCreditNoteTemplate'][0])
    {
        ...
        if ($credit_note_id === null || (is_array($credit_note_id) && count($credit_note_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $credit_note_id when calling updateCreditNoteTemplate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($model_change_layout)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($model_change_layout));
            } else {
                $httpBody = $model_change_layout;
            }
    ...
    /**
     * Operation updateInvoiceTemplate
     *
    ...
    /**
     * Operation updateInvoiceTemplateWithHttpInfo
     *
     * Update an invoice template
     *
     * @param  int $invoice_id ID of invoice to update (required)
    ...
    /**
     * Operation updateInvoiceTemplateAsync
     *
     * Update an invoice template
     *
     * @param  int $invoice_id ID of invoice to update (required)
    ...
    /**
     * Operation updateInvoiceTemplateAsyncWithHttpInfo
     *
     * Update an invoice template
     *
     * @param  int $invoice_id ID of invoice to update (required)
    ...
    public function updateInvoiceTemplateRequest($invoice_id, $model_change_layout = null, string $contentType = self::contentTypes['updateInvoiceTemplate'][0])
    {
        ...
        if ($invoice_id === null || (is_array($invoice_id) && count($invoice_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $invoice_id when calling updateInvoiceTemplate'
            );
        }
    ...
    /**
     * Operation updateOrderTemplateWithHttpInfo
     *
     * Update an order template
     *
     * @param  int $order_id ID of order to update (required)
    ...
    /**
     * Operation updateOrderTemplateAsync
     *
     * Update an order template
     *
     * @param  int $order_id ID of order to update (required)
    ...
    /**
     * Operation updateOrderTemplateAsyncWithHttpInfo
     *
     * Update an order template
     *
     * @param  int $order_id ID of order to update (required)
    ...
    public function updateOrderTemplateRequest($order_id, $model_change_layout = null, string $contentType = self::contentTypes['updateOrderTemplate'][0])
    {
        ...
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling updateOrderTemplate'
            );
        }
