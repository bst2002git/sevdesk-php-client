...
/**
    ...
    {
        list($response) = $this->deleteOrderPosWithHttpInfo($order_pos_id, $contentType);
        return $response;
    }

    /**
     * Operation deleteOrderPosWithHttpInfo
     *
     * Deletes an order Position
     *
     * @param  int $order_pos_id Id of order position resource to delete (required)
     ...
     */
    public function deleteOrderPosAsync($order_pos_id, string $contentType = self::contentTypes['deleteOrderPos'][0])
    {
        return $this->deleteOrderPosAsyncWithHttpInfo($order_pos_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteOrderPosAsyncWithHttpInfo
     *
     * Deletes an order Position
     *
     * @param  int $order_pos_id Id of order position resource to delete (required)
    ...
    /**
     * Create request for operation 'deleteOrderPos'
     *
     * @param  int $order_pos_id Id of order position resource to delete (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteOrderPos'] to see the possible values for this operation
     *
     ...
     */
    public function deleteOrderPosRequest($order_pos_id, string $contentType = self::contentTypes['deleteOrderPos'][0])
    {

        // verify the required parameter 'order_pos_id' is set
        if ($order_pos_id === null || (is_array($order_pos_id) && count($order_pos_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_pos_id when calling deleteOrderPos'
            );
        }


        $resourcePath = '/OrderPos/{orderPosId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($order_pos_id !== null) {
            $resourcePath = str_replace(
                '{' . 'orderPosId' . '}',
                ObjectSerializer::toPathValue($order_pos_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getOrderPositionById
     *
    ...
    {
        list($response) = $this->getOrderPositionByIdWithHttpInfo($order_pos_id, $contentType);
        return $response;
    }

    /**
     * Operation getOrderPositionByIdWithHttpInfo
     *
     * Find order position by ID
     *
     * @param  int $order_pos_id ID of order position to return (required)
    ...
    /**
     * Operation getOrderPositionByIdAsync
     *
     * Find order position by ID
     *
     * @param  int $order_pos_id ID of order position to return (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderPositionByIdAsync($order_pos_id, string $contentType = self::contentTypes['getOrderPositionById'][0])
    {
        return $this->getOrderPositionByIdAsyncWithHttpInfo($order_pos_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrderPositionByIdAsyncWithHttpInfo
     *
     * Find order position by ID
     *
     * @param  int $order_pos_id ID of order position to return (required)
    ...
    /**
     * Create request for operation 'getOrderPositionById'
     *
     * @param  int $order_pos_id ID of order position to return (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOrderPositionById'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderPositionByIdRequest($order_pos_id, string $contentType = self::contentTypes['getOrderPositionById'][0])
    {

        // verify the required parameter 'order_pos_id' is set
        if ($order_pos_id === null || (is_array($order_pos_id) && count($order_pos_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_pos_id when calling getOrderPositionById'
            );
        }
    ...
    /**
     * Operation getOrderPositions
     *
     * Retrieve order positions
     *
     * @param  int $order_id Retrieve all order positions belonging to this order. Must be provided with voucher[objectName] (optional)
    ...
    {
        list($response) = $this->getOrderPositionsWithHttpInfo($order_id, $order_object_name, $contentType);
        return $response;
    }

    /**
     * Operation getOrderPositionsWithHttpInfo
     *
     * Retrieve order positions
     *
     * @param  int $order_id Retrieve all order positions belonging to this order. Must be provided with voucher[objectName] (optional)
    ...
    /**
     * Operation getOrderPositionsAsync
     *
     * Retrieve order positions
     *
     * @param  int $order_id Retrieve all order positions belonging to this order. Must be provided with voucher[objectName] (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderPositionsAsync($order_id = null, $order_object_name = null, string $contentType = self::contentTypes['getOrderPositions'][0])
    {
        return $this->getOrderPositionsAsyncWithHttpInfo($order_id, $order_object_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrderPositionsAsyncWithHttpInfo
     *
     * Retrieve order positions
     *
     * @param  int $order_id Retrieve all order positions belonging to this order. Must be provided with voucher[objectName] (optional)
    ...
    /**
     * Create request for operation 'getOrderPositions'
     *
     * @param  int $order_id Retrieve all order positions belonging to this order. Must be provided with voucher[objectName] (optional)
     * @param  string $order_object_name Only required if order[id] was provided. &#39;Order&#39; should be used as value. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOrderPositions'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderPositionsRequest($order_id = null, $order_object_name = null, string $contentType = self::contentTypes['getOrderPositions'][0])
    {




        $resourcePath = '/OrderPos';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->updateOrderPositionWithHttpInfo($order_pos_id, $model_order_pos_update, $contentType);
        return $response;
    }

    /**
     * Operation updateOrderPositionWithHttpInfo
     *
     * Update an existing order position
     *
     * @param  int $order_pos_id ID of order position to update (required)
    ...
    /**
     * Operation updateOrderPositionAsync
     *
     * Update an existing order position
     *
     * @param  int $order_pos_id ID of order position to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateOrderPositionAsync($order_pos_id, $model_order_pos_update = null, string $contentType = self::contentTypes['updateOrderPosition'][0])
    {
        return $this->updateOrderPositionAsyncWithHttpInfo($order_pos_id, $model_order_pos_update, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateOrderPositionAsyncWithHttpInfo
     *
     * Update an existing order position
     *
     * @param  int $order_pos_id ID of order position to update (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateOrderPositionRequest($order_pos_id, $model_order_pos_update = null, string $contentType = self::contentTypes['updateOrderPosition'][0])
    {

        // verify the required parameter 'order_pos_id' is set
        if ($order_pos_id === null || (is_array($order_pos_id) && count($order_pos_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_pos_id when calling updateOrderPosition'
            );
        }
        ...
        // for model (json/xml)
        if (isset($model_order_pos_update)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($model_order_pos_update));
            } else {
                $httpBody = $model_order_pos_update;
            }
