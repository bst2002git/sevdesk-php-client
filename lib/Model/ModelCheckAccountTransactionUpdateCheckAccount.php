...
/**
 * ModelCheckAccountTransactionUpdateCheckAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCheckAccountTransactionUpdateCheckAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_CheckAccountTransactionUpdate_checkAccount';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Unique identifier of the check account
     *
     * @return self
     */
