...
/**
 * GetContactTabsItemCountById200Response Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class GetContactTabsItemCountById200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getContactTabsItemCountById_200_response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('invoice_pos', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets orders
     *
     * @param float|null $orders orders
     *
     * @return self
     */
     ...
     * Sets invoices
     *
     * @param float|null $invoices invoices
     *
     * @return self
     */
     ...
     * Sets credit_notes
     *
     * @param float|null $credit_notes credit_notes
     *
     * @return self
     */
     ...
     * Sets documents
     *
     * @param float|null $documents documents
     *
     * @return self
     */
     ...
     * Sets persons
     *
     * @param float|null $persons persons
     *
     * @return self
     */
     ...
     * Sets vouchers
     *
     * @param float|null $vouchers vouchers
     *
     * @return self
     */
     ...
     * Sets letters
     *
     * @param float|null $letters letters
     *
     * @return self
     */
    ...
    {
        if (is_null($letters)) {
            throw new \InvalidArgumentException('non-nullable letters cannot be null');
        }
    ...
    {
        return $this->container['invoice_pos'];
    }

    /**
     * Sets invoice_pos
     *
     * @param float|null $invoice_pos invoice_pos
     *
     * @return self
     */
    public function setInvoicePos($invoice_pos)
    {
        if (is_null($invoice_pos)) {
            throw new \InvalidArgumentException('non-nullable invoice_pos cannot be null');
        }
        $this->container['invoice_pos'] = $invoice_pos;
