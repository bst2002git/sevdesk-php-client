...
/**
 * SaveOrderOrderPosDelete Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class SaveOrderOrderPosDelete implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveOrder_orderPosDelete';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Id of order position
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Object name of order position
     *
     * @return self
     */
