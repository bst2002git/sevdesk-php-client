 ...
 */
class ModelCheckAccountTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_CheckAccountTransaction';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payee_payer_name'] === null) {
            $invalidProperties[] = "'payee_payer_name' can't be null";
        }
     ...
     * Sets id
     *
     * @param int|null $id The check account transaction id
     *
     * @return self
     */
     ...
     * Sets value_date
     *
     * @param \DateTime $value_date Date the check account transaction was booked
     *
     * @return self
     */
     ...
     *
     * @param string $payee_payer_name Name of the payee/payer
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param int $status Status of the check account transaction.<br>       100 <-> Created<br>       200 <-> Linked<br>       300 <-> Private<br>       400 <-> Booked
     *
     * @return self
     */
