 ...
 */
class ModelOrderPosUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_OrderPosUpdate';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The order position id
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Quantity of the article/part
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param float|null $name Name of the article/part.
     *
     * @return self
     */
     ...
     * Sets tax_rate
     *
     * @param float|null $tax_rate Tax rate of the position.
     *
     * @return self
     */
