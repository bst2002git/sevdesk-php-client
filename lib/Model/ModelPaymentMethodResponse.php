...
/**
 * ModelPaymentMethodResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelPaymentMethodResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_PaymentMethodResponse';
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'text' => 'setText',
        'electronic_invoice_id' => 'setElectronicInvoiceId',
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'text' => 'getText',
        'electronic_invoice_id' => 'getElectronicInvoiceId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('electronic_invoice_id', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the payment method
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'PaymentMethod'
     *
     * @return self
     */
    ...
    /**
     * Gets electronic_invoice_id
     *
     * @return string|null
     */
    public function getElectronicInvoiceId()
    {
        return $this->container['electronic_invoice_id'];
    }

    /**
     * Sets electronic_invoice_id
     *
     * @param string|null $electronic_invoice_id 
     *
     * @return self
     */
    public function setElectronicInvoiceId($electronic_invoice_id)
    {
        if (is_null($electronic_invoice_id)) {
            throw new \InvalidArgumentException('non-nullable electronic_invoice_id cannot be null');
        }
        $this->container['electronic_invoice_id'] = $electronic_invoice_id;
     ...
     *
     * @param string|null $translation_code 
     *
     * @return self
     */
