...
/**
 * ModelEmailOrderObject Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelEmailOrderObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_EmailOrder_object';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'Invoice' or 'Order' or 'CreditNote'
     *
     * @return self
     */
