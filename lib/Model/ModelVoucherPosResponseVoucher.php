...
/**
 * ModelVoucherPosResponseVoucher Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelVoucherPosResponseVoucher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_VoucherPosResponse_voucher';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the voucher
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'Voucher'
     *
     * @return self
     */
