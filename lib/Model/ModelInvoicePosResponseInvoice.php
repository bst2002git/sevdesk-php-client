...
/**
 * ModelInvoicePosResponseInvoice Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelInvoicePosResponseInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_InvoicePosResponse_invoice';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the invoice
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'Invoice'
     *
     * @return self
     */
