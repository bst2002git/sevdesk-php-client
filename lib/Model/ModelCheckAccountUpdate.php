...
/**
 * ModelCheckAccountUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCheckAccountUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_CheckAccountUpdate';
    ...
    */
    ...
    public function setDefaultAccount($default_account)
    {
        ...
        $allowedValues = $this->getDefaultAccountAllowableValues();
        if (!in_array($default_account, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'default_account', must be one of '%s'",
                    $default_account,
