 ...
 */
class ModelInvoicePosUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_InvoicePosUpdate';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The invoice position id
     *
     * @return self
     */
