...
/**
 * ModelInvoicePosPart Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelInvoicePosPart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_InvoicePos_part';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Unique identifier of the part
     *
     * @return self
     */
