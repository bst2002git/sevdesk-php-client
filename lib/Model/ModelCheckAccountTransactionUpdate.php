 ...
 */
class ModelCheckAccountTransactionUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_CheckAccountTransactionUpdate';
    ...
    protected static $openAPITypes = [
        ...
        'check_account' => '\OpenAPI\Client\Model\ModelCheckAccountTransactionUpdateCheckAccount',
        'status' => 'int',
        'enshrined' => '\DateTime',
    ...
    */
     ...
     * Sets value_date
     *
     * @param \DateTime|null $value_date Date the check account transaction was booked
     *
     * @return self
     */
     ...
     * Sets entry_date
     *
     * @param \DateTime|null $entry_date Date the check account transaction was imported
     *
     * @return self
     */
    ...
    public function setPayeePayerName($payee_payer_name)
    {
        if (is_null($payee_payer_name)) {
            array_push($this->openAPINullablesSetToNull, 'payee_payer_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payee_payer_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets check_account
     *
     * @return \OpenAPI\Client\Model\ModelCheckAccountTransactionUpdateCheckAccount|null
     */
     ...
     * Sets check_account
     *
     * @param \OpenAPI\Client\Model\ModelCheckAccountTransactionUpdateCheckAccount|null $check_account check_account
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param int|null $status Status of the check account transaction.<br>       100 <-> Created<br>       200 <-> Linked<br>       300 <-> Private<br>       400 <-> Booked
     *
     * @return self
     */
    ...
    public function setSourceTransaction($source_transaction)
    {
        if (is_null($source_transaction)) {
            array_push($this->openAPINullablesSetToNull, 'source_transaction');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('source_transaction', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setTargetTransaction($target_transaction)
    {
        if (is_null($target_transaction)) {
            array_push($this->openAPINullablesSetToNull, 'target_transaction');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('target_transaction', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
