...
/**
 * SaveCreditNoteDiscountDelete Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SaveCreditNoteDiscountDelete implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveCreditNote_discountDelete';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id ID of discount to delete
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Object name of discount
     *
     * @return self
     */
