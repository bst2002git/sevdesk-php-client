...
/**
 * ModelVoucherUpdateDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelVoucherUpdateDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_VoucherUpdate_document';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Unique identifier of the document
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'Document'
     *
     * @return self
     */
