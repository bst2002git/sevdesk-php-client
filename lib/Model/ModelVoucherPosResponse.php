 ...
 */
class ModelVoucherPosResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_VoucherPosResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The voucher position id
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string|null $object_name The voucher position object name
     *
     * @return self
     */
     ...
     * Sets tax_rate
     *
     * @param string $tax_rate Tax rate of the voucher position.
     *
     * @return self
     */
     ...
     * Sets sum_net
     *
     * @param string $sum_net Net sum of the voucher position.<br>      Only regarded if 'net' is 'true', otherwise its readOnly.
     *
     * @return self
     */
     ...
     * Sets sum_tax
     *
     * @param string|null $sum_tax Tax sum of the voucher position.
     *
     * @return self
     */
     ...
     * Sets sum_gross
     *
     * @param string $sum_gross Gross sum of the voucher position.<br>      Only regarded if 'net' is 'false', otherwise its readOnly.
     *
     * @return self
     */
     ...
     *
     * @param string|null $sum_net_accounting Net accounting sum. Is equal to sumNet.
     *
     * @return self
     */
     ...
     *
     * @param string|null $sum_tax_accounting Tax accounting sum. Is equal to sumTax.
     *
     * @return self
     */
     ...
     *
     * @param string|null $sum_gross_accounting Gross accounting sum. Is equal to sumGross.
     *
     * @return self
     */
