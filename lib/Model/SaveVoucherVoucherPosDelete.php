...
/**
 * SaveVoucherVoucherPosDelete Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class SaveVoucherVoucherPosDelete implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveVoucher_voucherPosDelete';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Id of voucher position
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Object name of voucher position
     *
     * @return self
     */
