...
/**
 * ModelOrderResponseOrigin Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelOrderResponseOrigin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_OrderResponse_origin';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name of the object. Could be 'Order'.
     *
     * @return self
     */
