...
/**
 * ModelCreditNoteResponseContactPerson Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCreditNoteResponseContactPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_creditNoteResponse_contactPerson';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'SevUser'
     *
     * @return self
     */
