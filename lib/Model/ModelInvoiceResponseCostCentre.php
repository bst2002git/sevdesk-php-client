...
/**
 * ModelInvoiceResponseCostCentre Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelInvoiceResponseCostCentre implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_InvoiceResponse_costCentre';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the cost centre
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'CostCentre'
     *
     * @return self
     */
