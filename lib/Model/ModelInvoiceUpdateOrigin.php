...
/**
 * ModelInvoiceUpdateOrigin Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelInvoiceUpdateOrigin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_InvoiceUpdate_origin';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name. Could f.e. be 'Order''
     *
     * @return self
     */
