 ...
 */
class ExportTransactionsSevQueryParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'exportTransactions_sevQuery_parameter';
    ...
    */
     ...
     * Sets model_name
     *
     * @param mixed $model_name Model name, which is 'CheckAccountTransaction'
     *
     * @return self
     */
