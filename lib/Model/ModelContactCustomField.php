 ...
 */
class ModelContactCustomField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactCustomField';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contact_custom_field_setting'] === null) {
            $invalidProperties[] = "'contact_custom_field_setting' can't be null";
        }
     ...
     * Sets value
     *
     * @param string $value The value of the contact field
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Internal object name which is 'ContactCustomField'.
     *
     * @return self
     */
