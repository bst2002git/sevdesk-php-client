 ...
 */
class ReportOrderSevQueryParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reportOrder_sevQuery_parameter';
