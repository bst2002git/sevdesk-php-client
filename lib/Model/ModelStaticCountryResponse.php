...
/**
 * ModelStaticCountryResponse Class Doc Comment
 *
 * @category Class
 * @description Information on the country
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ModelStaticCountryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_StaticCountryResponse';
    ...
    public const OBJECT_NAME_STATIC_COUNTRY = 'StaticCountry';
    ...
    {
        return [
            self::OBJECT_NAME_STATIC_COUNTRY,
        ];
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the country
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'StaticCountry'
     *
     * @return self
     */
