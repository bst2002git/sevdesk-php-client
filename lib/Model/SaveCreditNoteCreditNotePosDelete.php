...
/**
 * SaveCreditNoteCreditNotePosDelete Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class SaveCreditNoteCreditNotePosDelete implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveCreditNote_creditNotePosDelete';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Id of credit note position
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Object name of credit note position
     *
     * @return self
     */
