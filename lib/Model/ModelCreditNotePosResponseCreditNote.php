...
/**
 * ModelCreditNotePosResponseCreditNote Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCreditNotePosResponseCreditNote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_creditNotePosResponse_creditNote';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the creditNote
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'creditNote'
     *
     * @return self
     */
