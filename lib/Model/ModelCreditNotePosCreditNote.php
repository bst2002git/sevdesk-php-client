...
/**
 * ModelCreditNotePosCreditNote Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCreditNotePosCreditNote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_creditNotePos_creditNote';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Unique identifier of the creditNote
     *
     * @return self
     */
