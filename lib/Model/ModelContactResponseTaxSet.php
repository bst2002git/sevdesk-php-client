...
/**
 * ModelContactResponseTaxSet Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelContactResponseTaxSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactResponse_taxSet';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the tax set
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'TaxSet'
     *
     * @return self
     */
