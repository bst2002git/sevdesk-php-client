...
/**
 * ModelCheckAccountTransactionResponseCheckAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCheckAccountTransactionResponseCheckAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_CheckAccountTransactionResponse_checkAccount';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the check account
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'CheckAccount'
     *
     * @return self
     */
