...
/**
 * ModelInvoiceUpdateCostCentre Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelInvoiceUpdateCostCentre implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_InvoiceUpdate_costCentre';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Unique identifier of the cost centre
     *
     * @return self
     */
