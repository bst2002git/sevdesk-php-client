 ...
 */
class ModelCommunicationWay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_CommunicationWay';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The communication way id
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value The value of the communication way.<br>       For example the phone number, e-mail address or website.
     *
     * @return self
     */
