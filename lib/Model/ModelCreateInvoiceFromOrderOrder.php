...
/**
 * ModelCreateInvoiceFromOrderOrder Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCreateInvoiceFromOrderOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_CreateInvoiceFromOrder_order';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'Order'
     *
     * @return self
     */
