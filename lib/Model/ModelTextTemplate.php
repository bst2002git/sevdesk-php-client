 ...
 */
class ModelTextTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_TextTemplate';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name for the new Text Template.
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text The text of the new Text Template.
     *
     * @return self
     */
