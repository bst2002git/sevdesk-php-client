 ...
 */
class ModelOrderPos implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_OrderPos';
    ...
    */
     ...
     * Sets create
     *
     * @param string|null $create Date of order position creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param string|null $update Date of last order position update
     *
     * @return self
     */
