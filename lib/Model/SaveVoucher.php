 ...
 */
class SaveVoucher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveVoucher';
    ...
    protected static array $openAPINullables = [
        'voucher' => false,
		'voucher_pos_save' => false,
		'voucher_pos_delete' => false,
		'filename' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('voucher_pos_save', $data ?? [], null);
        $this->setIfExists('voucher_pos_delete', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($voucher_pos_save)) {
            throw new \InvalidArgumentException('non-nullable voucher_pos_save cannot be null');
        }
    ...
    {
        if (is_null($voucher_pos_delete)) {
            throw new \InvalidArgumentException('non-nullable voucher_pos_delete cannot be null');
        }
