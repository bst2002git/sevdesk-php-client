...
/**
 * CreateTagRequestObject Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateTagRequestObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createTag_request_object';
    ...
    public const OBJECT_NAME_ORDER = 'Order';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Id of the invoice/order/voucher/creditNote
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name
     *
     * @return self
     */
