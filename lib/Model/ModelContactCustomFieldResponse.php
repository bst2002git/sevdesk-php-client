 ...
 */
class ModelContactCustomFieldResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactCustomFieldResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id id of the contact field
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param \DateTime|null $create Date of contact field creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \DateTime|null $update Date of contact field update
     *
     * @return self
     */
