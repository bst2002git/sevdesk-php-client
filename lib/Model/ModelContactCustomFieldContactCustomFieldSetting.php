...
/**
 * ModelContactCustomFieldContactCustomFieldSetting Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelContactCustomFieldContactCustomFieldSetting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactCustomField_contactCustomFieldSetting';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Unique identifier of contact custom field setting
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'contactCustomFieldSetting'
     *
     * @return self
     */
