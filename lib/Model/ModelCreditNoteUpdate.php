 ...
 */
class ModelCreditNoteUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_creditNoteUpdate';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The creditNote id
     *
     * @return self
     */
     ...
     * Sets tax_rate
     *
     * @param float|null $tax_rate Is overwritten by creditNote position tax rates
     *
     * @return self
     */
