 ...
 */
class ExportTransactionsSevQueryParameterFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'exportTransactions_sevQuery_parameter_filter';
    ...
    */
     ...
     * Sets paymt_purpose
     *
     * @param string|null $paymt_purpose the payment purpose
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name the name of the payee/payer
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date Start date of the transactions
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date End date of the transactions
     *
     * @return self
     */
     ...
     * Sets start_amount
     *
     * @param int|null $start_amount filters the transactions by amount
     *
     * @return self
     */
     ...
     * Sets end_amount
     *
     * @param int|null $end_amount filters the transactions by amount
     *
     * @return self
     */
