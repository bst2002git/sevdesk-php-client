 ...
 */
class ModelContactCustomFieldSettingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactCustomFieldSettingResponse';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string|null $object_name Internal object name which is 'ContactCustomFieldSetting'.
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \DateTime|null $update Date of contact field updated
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name name of the contact fields
     *
     * @return self
     */
     ...
     * Sets identifier
     *
     * @param string|null $identifier Unique identifier for the contact field
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of the contact field
     *
     * @return self
     */
