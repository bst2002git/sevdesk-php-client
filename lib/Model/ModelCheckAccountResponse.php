...
/**
 * ModelCheckAccountResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCheckAccountResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_CheckAccountResponse';
    ...
    protected static $openAPITypes = [
        ...
        'create' => '\DateTime',
        'update' => '\DateTime',
        'sev_client' => '\Itsmind\\Sevdesk\Model\ModelCheckAccountResponseSevClient',
        'name' => 'string',
        'type' => 'string',
        'import_type' => 'string',
        'currency' => 'string',
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The check account id
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \Itsmind\\Sevdesk\Model\ModelCheckAccountResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \Itsmind\\Sevdesk\Model\ModelCheckAccountResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the check account
     *
     * @return self
     */
     ...
     *
     * @param string|null $default_account Defines if this check account is the default account.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the check account. 0 <-> Archived - 100 <-> Active
     *
     * @return self
     */
     ...
     *
     * @param string|null $auto_map_transactions Defines if transactions on this account are automatically mapped to invoice and vouchers when imported if possible.
     *
     * @return self
     */
