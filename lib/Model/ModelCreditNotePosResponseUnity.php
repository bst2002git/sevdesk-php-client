...
/**
 * ModelCreditNotePosResponseUnity Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCreditNotePosResponseUnity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_creditNotePosResponse_unity';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the unit
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'Unity'
     *
     * @return self
     */
