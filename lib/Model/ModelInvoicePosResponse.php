 ...
 */
class ModelInvoicePosResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_InvoicePosResponse';
    ...
    protected static $openAPITypes = [
        ...
        'create' => '\DateTime',
        'update' => '\DateTime',
        'invoice' => '\Itsmind\\Sevdesk\Model\ModelInvoicePosResponseInvoice',
        'part' => '\Itsmind\\Sevdesk\Model\ModelInvoicePosResponsePart',
        'quantity' => 'string',
        'price' => 'string',
        'name' => 'string',
        'unity' => '\Itsmind\\Sevdesk\Model\ModelInvoicePosResponseUnity',
        'sev_client' => '\Itsmind\\Sevdesk\Model\ModelInvoicePosResponseSevClient',
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The invoice position id
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string|null $object_name The invoice position object name
     *
     * @return self
     */
     ...
     * Gets invoice
     *
     * @return \Itsmind\\Sevdesk\Model\ModelInvoicePosResponseInvoice|null
     */
     ...
     * Sets invoice
     *
     * @param \Itsmind\\Sevdesk\Model\ModelInvoicePosResponseInvoice|null $invoice invoice
     *
     * @return self
     */
     ...
     * Gets part
     *
     * @return \Itsmind\\Sevdesk\Model\ModelInvoicePosResponsePart|null
     */
     ...
     * Sets part
     *
     * @param \Itsmind\\Sevdesk\Model\ModelInvoicePosResponsePart|null $part part
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param string|null $quantity Quantity of the article/part
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param string|null $price Price of the article/part. Is either gross or net, depending on the sevDesk account setting.
     *
     * @return self
     */
     ...
     * Gets unity
     *
     * @return \Itsmind\\Sevdesk\Model\ModelInvoicePosResponseUnity|null
     */
     ...
     * Sets unity
     *
     * @param \Itsmind\\Sevdesk\Model\ModelInvoicePosResponseUnity|null $unity unity
     *
     * @return self
     */
     ...
     * Gets sev_client
     *
     * @return \Itsmind\\Sevdesk\Model\ModelInvoicePosResponseSevClient|null
     */
     ...
     * Sets sev_client
     *
     * @param \Itsmind\\Sevdesk\Model\ModelInvoicePosResponseSevClient|null $sev_client sev_client
     *
     * @return self
     */
     ...
     *
     * @param string|null $position_number Position number of your position. Can be used to order multiple positions.
     *
     * @return self
     */
     ...
     * Sets discount
     *
     * @param string|null $discount An optional discount of the position.
     *
     * @return self
     */
     ...
     * Sets tax_rate
     *
     * @param string|null $tax_rate Tax rate of the position.
     *
     * @return self
     */
     ...
     * Sets sum_discount
     *
     * @param string|null $sum_discount Discount sum of the position
     *
     * @return self
     */
    public function setSumDiscount($sum_discount)
    {
        if (is_null($sum_discount)) {
            throw new \InvalidArgumentException('non-nullable sum_discount cannot be null');
        }
     ...
     *
     * @param string|null $sum_net_accounting Net accounting sum of the position
     *
     * @return self
     */
     ...
     *
     * @param string|null $sum_tax_accounting Tax accounting sum of the position
     *
     * @return self
     */
     ...
     *
     * @param string|null $sum_gross_accounting Gross accounting sum of the position
     *
     * @return self
     */
     ...
     * Sets price_net
     *
     * @param string|null $price_net Net price of the part
     *
     * @return self
     */
     ...
     * Sets price_gross
     *
     * @param string|null $price_gross Gross price of the part
     *
     * @return self
     */
    public function setPriceGross($price_gross)
    {
        if (is_null($price_gross)) {
            throw new \InvalidArgumentException('non-nullable price_gross cannot be null');
        }
     ...
     * Sets price_tax
     *
     * @param string|null $price_tax Tax on the price of the part
     *
     * @return self
     */
