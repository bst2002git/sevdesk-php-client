...
/**
 * ModelInvoiceOrigin Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelInvoiceOrigin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_Invoice_origin';
    ...
    */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which could be 'Order'
     *
     * @return self
     */
