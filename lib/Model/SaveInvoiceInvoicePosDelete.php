...
/**
 * SaveInvoiceInvoicePosDelete Class Doc Comment
 *
 * @category Class
 * @package  Itsmind\\Sevdesk
 * @author   OpenAPI Generator team
 ...
 */
class SaveInvoiceInvoicePosDelete implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'saveInvoice_invoicePosDelete';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Id of invoice position
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Object name of invoice position
     *
     * @return self
     */
