 ...
 */
class ModelAccountingContactResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_AccountingContactResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The accounting contact id
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string|null $object_name The accounting contact object name
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param \DateTime|null $create Date of accounting contact creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \DateTime|null $update Date of last accounting contact update
     *
     * @return self
     */
     ...
     * Sets debitor_number
     *
     * @param string|null $debitor_number Debitor number of the accounting contact.
     *
     * @return self
     */
    public function setDebitorNumber($debitor_number)
    {
        if (is_null($debitor_number)) {
            throw new \InvalidArgumentException('non-nullable debitor_number cannot be null');
        }
     ...
     *
     * @param string|null $creditor_number Creditor number of the accounting contact.
     *
     * @return self
     */
    public function setCreditorNumber($creditor_number)
    {
        if (is_null($creditor_number)) {
            throw new \InvalidArgumentException('non-nullable creditor_number cannot be null');
        }
