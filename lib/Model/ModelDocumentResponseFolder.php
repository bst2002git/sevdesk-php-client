...
/**
 * ModelDocumentResponseFolder Class Doc Comment
 *
 * @category Class
 * @description The folder this document is located in.
 * @package  Itsmind\Sevdesk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ModelDocumentResponseFolder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_DocumentResponse_folder';
    ...
    public const OBJECT_NAME_DOCUMENT_FOLDER = 'DocumentFolder';
    ...
    {
        return [
            self::OBJECT_NAME_DOCUMENT_FOLDER,
        ];
    }
    ...
    */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'DocumentFolder'
     *
     * @return self
     */
