 ...
 */
class ModelContactResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_ContactResponse';
    ...
    protected static array $openAPINullables = [
		...
		'bank_account' => false,
		'bank_number' => false,
		'default_cashback_time' => false,
		'default_cashback_percent' => false,
		'default_time_to_pay' => false,
		'tax_number' => false,
		'tax_office' => false,
		'exempt_vat' => false,
		'tax_type' => false,
		'tax_set' => false,
		'default_discount_amount' => false,
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The contact id
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string|null $object_name The contact object name
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param \DateTime|null $create Date of contact creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \DateTime|null $update Date of last contact update
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Defines the status of the contact. 100 <-> Lead - 500 <-> Pending - 1000 <-> Active.
     *
     * @return self
     */
    ...
    {
        if (is_null($surename)) {
            throw new \InvalidArgumentException('non-nullable surename cannot be null');
        }
    ...
    public function setAcademicTitle($academic_title)
    {
        if (is_null($academic_title)) {
            throw new \InvalidArgumentException('non-nullable academic_title cannot be null');
        }
     ...
     *
     * @param string|null $default_cashback_time Absolute time in days which the contact has to pay his invoices and subsequently get a cashback.
     *
     * @return self
     */
    public function setDefaultCashbackTime($default_cashback_time)
    {
        if (is_null($default_cashback_time)) {
            throw new \InvalidArgumentException('non-nullable default_cashback_time cannot be null');
        }
    ...
    public function setDefaultCashbackPercent($default_cashback_percent)
    {
        if (is_null($default_cashback_percent)) {
            throw new \InvalidArgumentException('non-nullable default_cashback_percent cannot be null');
        }
     ...
     *
     * @param string|null $default_time_to_pay The payment goal in days which is set for every invoice of the contact.
     *
     * @return self
     */
    public function setDefaultTimeToPay($default_time_to_pay)
    {
        if (is_null($default_time_to_pay)) {
            throw new \InvalidArgumentException('non-nullable default_time_to_pay cannot be null');
        }
     ...
     * Sets exempt_vat
     *
     * @param string|null $exempt_vat Defines if the contact is freed from paying vat.
     *
     * @return self
     */
    public function setExemptVat($exempt_vat)
    {
        if (is_null($exempt_vat)) {
            throw new \InvalidArgumentException('non-nullable exempt_vat cannot be null');
        }
    ...
    public function setDefaultDiscountAmount($default_discount_amount)
    {
        if (is_null($default_discount_amount)) {
            throw new \InvalidArgumentException('non-nullable default_discount_amount cannot be null');
        }
     ...
     *
     * @param string|null $default_discount_percentage Defines if the discount is a percentage (true) or an absolute value (false).
     *
     * @return self
     */
    public function setDefaultDiscountPercentage($default_discount_percentage)
    {
        if (is_null($default_discount_percentage)) {
            throw new \InvalidArgumentException('non-nullable default_discount_percentage cannot be null');
        }
     ...
     *
     * @param string|null $government_agency Defines whether the contact is a government agency (true) or not (false).
     *
     * @return self
     */
    public function setGovernmentAgency($government_agency)
    {
        if (is_null($government_agency)) {
            throw new \InvalidArgumentException('non-nullable government_agency cannot be null');
        }
     ...
     *
     * @param string|null $additional_information Additional information stored for the contact.
     *
     * @return self
     * @deprecated
     */
