 ...
 */
class ModelDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_Discount';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id the id of the discount
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string|null $object_name Model name, which is 'Discounts'
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param \DateTime|null $create Date of discount creation
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \DateTime|null $update Date of last discount update
     *
     * @return self
     */
     ...
     * Sets sev_client
     *
     * @param string|null $sev_client Client to which invoice belongs. Will be filled automatically
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param string|null $percentage Defines if this is a percentage or an absolute discount
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Value of the discount
     *
     * @return self
     */
     ...
     * Sets is_net
     *
     * @param string|null $is_net Defines is the Discount net or gross 0 - gross 1 - net
     *
     * @return self
     */
