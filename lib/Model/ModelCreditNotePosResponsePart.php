...
/**
 * ModelCreditNotePosResponsePart Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelCreditNotePosResponsePart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Model_creditNotePosResponse_part';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier of the part
     *
     * @return self
     */
     ...
     * Sets object_name
     *
     * @param string $object_name Model name, which is 'Part'
     *
     * @return self
     */
